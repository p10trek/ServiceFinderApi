...
namespace ServiceFinderApi.Controllers
{
    public class CustomersController : MyControllerBase
    {
        ...
        //public async Task<IActionResult> Create([Bind("Id,Login,Password,Name,Phone,Email")] Customer customer)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(Guid id, [Bind("Id,Login,Password,Name,Phone,Email")] Customer customer)
        //{
        //    if (id != customer.Id)
        //    {
        //        return NotFound();
